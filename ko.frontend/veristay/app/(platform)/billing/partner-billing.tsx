...
const PartnerBilling = () => {
    ...
    const handlePaymentStatusUpdate = (
        ...
        const updateStudentPayments = (student: StudentModel) => ({
            ...student,
            coursePayments: student.coursePayments.map((payment: CoursePayment) => {
        ...
        if (selectedStudent) {
            setSelectedStudent((prevSelected) => ({
                ...prevSelected!,
                coursePayments: prevSelected!.coursePayments.map((payment: CoursePayment) =>
    ...
    return (
        <div className="space-y-8">
            ...
            <section>
                <Header
                    title="Partner Billing Management"
                    description={'Manage billing and payments for your institution'}
                />
                ...
                <div className="mb-6 flex justify-end">
                    <DownloadSummaryReport
                        students={students}
                        reportTitle="Partner Institution Billing Summary"
                        generatedBy="Partner Institution"
                ...
                <div className="grid gap-4 md:grid-cols-4 mb-8">
                    <EnrollmentCard
                        title={'Total Revenue'}
                        totalNumber={totalRevenue.toLocaleString('en-ZA', {
                            style: 'currency',
                            currency: 'ZAR',
                        })}
                        icon={Shield}
                    ...
                    <EnrollmentCard
                        title={'Paid Payments'}
                        totalNumber={paidPayments}
                        icon={CheckCircle}
                        color={'green'}
                    />
                    <EnrollmentCard
                        title={'Pending Payments'}
                        totalNumber={pendingPayments}
                        icon={Loader2}
                        color={'yellow'}
                    />
                    <EnrollmentCard
                        title={'Overdue Payments'}
                        totalNumber={overduePayments}
                        icon={XCircle}
                        color={'red'}
                    />
                </div>
