...
import { TrainingCenterReasons } from './CenterReasons';
    ...
    return (
        ...
        >
            ...
            <p className="text-sm md:text-lg text-neutral-500 text-center max-w-2xl mx-auto py-4 px-4">
                Our platform is designed to revolutionize security training by making it more
                accessible, scalable, and efficient for both students and training centers.
            </p>
